...
#     **Вывод:** Парам пам-пам
#
# yourpoem = input('Введи стишок , дружок пирожок')
# print(yourpoem)
# def checkrifma(stroka):
#     poem = stroka.lower().split()
#     f = lambda x: sum(1 for i in x if i in 'аеёиоуыэюя')
#     tmp = f(poem[0])
#     if all([f(i) == tmp for i in poem]):
#         return 'Парам пам-пам'
#     return 'Пам парам'
#
#
# print(checkrifma(yourpoem))
#
# print(checkrifma("И-не-важно,-чем-он-занят, Если-он-худеть-не-станет,"))
...
numr=int(input('Введите кол-во строк'))
numc=int(input("Введите кол-во столбцов"))
print_operation_table(lambda x, y: x * y, numr,numc)
